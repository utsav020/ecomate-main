    ...
    <section className="relative py-16 overflow-hidden">
      <div className="max-w-[1430px] mx-auto relative">
       <div className="">
        ...
        {/* Navigation Buttons */}
        <div className="w-[50px] h-[50px] flex items-center justify-center absolute left-2 md:left-142 top-1/2 -translate-y-1/2 z-30 bg-gray-400 rounded-full text-white p-3 transition-all">
          <button onClick={() => swiperRef.current?.slidePrev()} className="">
            <ArrowLeft className="w-10 h-10" />
          </button>
        </div>

        <div className="absolute flex items-center justify-center right-2 md:right-135 w-[50px] h-[50px] top-1/2 -translate-y-1/2 z-30 bg-gray-400 text-white p-3 rounded-full shadow-md transition-all">
          ...
          {testimonials.map((t) => (
            <SwiperSlide className="" key={t.id}>
              <div className="h-[520px]">
                <div className="w-[623px] flex h-[360px] bg-white shadow-xl rounded-[30px]">
                  <div className="w-[432px] pl-[35px] pt-[20px] max-w-[432px] h-[490px]">
                    <div className="h-[30px] w-[30px]">
                      <p className="text-[70px] text-[#F39C33]">“</p>
                    </div>

                    <div className="w-[336px] mt-[35px] h-[200px]">
                      <p className="text-[20px] font-medium">{t.text}</p>
                    </div>

                    <div className="w-[336px] mt-[15px] h-[38px]">
                  ...
                  <div className="w-[339px] h-[490px] overflow-hidden">
                    {/* Image Section  */}
                    <div className="">
                      <img
                        src={t.image}
                        alt={t.name}
                        className="w-[339px] h-[360px] rounded-r-[30px]"
                      />
                    </div>
                  </div>
                </div>
